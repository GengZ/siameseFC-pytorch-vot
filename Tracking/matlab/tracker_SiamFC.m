...
% error('Tracker not configured! Please edit the tracker_SiamRPN.m file.'); % Remove this line after proper configuration
...
tracker_command = generate_python_command('vot_SiamFC', {'/home/gzhan/baseline/track.baseline/Tracking'});
